<div class="main-panel">
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0">This is The Admin Page</h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block">Only Aprian is allowed to Modify Changes Here!</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Apry_productions 2022</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
